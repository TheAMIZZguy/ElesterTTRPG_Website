...
tags:
  ...
  - Trip
description: >-
  A chain whip has a series of razor-sharp blades set along its tip. Unlike
  ordinary whips, a chain whip doesn’t have the nonlethal trait, making it
  deadlier in combat but less effective when the wielder seeks to bring in foes
  alive.
Hardness: '5'
HP: '20'
BT: '10'
...
GraphView: '[[Flexible]]'
file.name: Chain Whip
file.path: 4. Items/Weapons/Flexible/Chain Whip.md
...
| --------------------------------------------------- | ------------------------------ | ------------------------------------- |
| **Damage**: 1d4 Slashing | **Hardness**: — | **Bulk**: L                |
| **Hands**: 1                            | **HP**: 20             | **Category**: Simple |
| **Range**: Melee                            | **BT**: 10             | **Group**: Flexible       |

## Description
*A chain whip has a series of razor-sharp blades set along its tip. Unlike ordinary whips, a chain whip doesn’t have the nonlethal trait, making it deadlier in combat but less effective when the wielder seeks to bring in foes alive.*
...
## Critical Effect
The target of the attack becomes [[Prone]].
