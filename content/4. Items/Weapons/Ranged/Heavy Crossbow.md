...
tags:
  - Reload
description: >-
  This large crossbow is harder to load and more substantial than a regular
  crossbow, but it packs a greater punch. $$$$ Reload 1
Hardness: '3'
HP: '12'
BT: '6'
primary-material: Wood
GraphView: '[[Ranged]]'
file.name: Heavy Crossbow
file.path: 4. Items/Weapons/Ranged/Heavy Crossbow.md
...
| --------------------------------------------------- | ------------------------------ | ------------------------------------- |
| **Damage**: 2d6 Piercing | **Hardness**: — | **Bulk**: 2                |
| **Hands**: 1                            | **HP**: 12             | **Category**: Advanced |
| **Range**: 24                            | **BT**: 6             | **Group**: Ranged       |

## Description
*This large crossbow is harder to load and more substantial than a regular crossbow, but it packs a greater punch. $$$$ Reload 1*
