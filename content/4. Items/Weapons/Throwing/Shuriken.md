...
tags:
  ...
  - Thrown
description: >-
  This “throwing star” is a small piece of flat metal with sharp edges, designed
  to be flung with a flick of the wrist.
Hardness: '5'
HP: '10'
BT: '5'
...
GraphView: '[[Throwing]]'
file.name: Shuriken
file.path: 4. Items/Weapons/Throwing/Shuriken.md
...
| --------------------------------------------------- | ------------------------------ | ------------------------------------- |
| **Damage**: 1d4 Slashing (Piercing) | **Hardness**: — | **Bulk**: L                |
| **Hands**: 1                            | **HP**: 10             | **Category**: Martial |
| **Range**: Throwing                            | **BT**: 5             | **Group**: Throwing       |
...
## Critical Effect
The target of the attack gains [[Persistent Damage|1d6 Persistent Bleeding]].
