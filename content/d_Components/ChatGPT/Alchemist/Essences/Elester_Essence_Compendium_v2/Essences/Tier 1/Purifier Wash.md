...
tags:
  ...
  - solvent
  - tier-1
description: Neutralizes residue and minor contamination.
price: TODO
chance-of-detection: 0%
file.name: Purifier Wash
file.path: >-
...
## Description
*Neutralizes residue and minor contamination.*
...
| Potency | Effects |
|---|---|
| **Potent** | End up to two minor residue effects (or one severe) (GM). |
| **Standard** | End one residue effect (GM). |
| **Diluted** | End one residue effect (GM). (weaker; shorten duration / reduce magnitude). |
