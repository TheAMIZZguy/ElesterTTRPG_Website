...
tags:
  ...
  - md
  - tier-1
description: 'Fine dust that bites the eyes and attention, making precision difficult.'
price: TODO
chance-of-detection: 0%
file.name: Biting Dust
file.path: >-
...
## Description
*Fine dust that bites the eyes and attention, making precision difficult.*
...
| Potency | Effects |
|---|---|
| **Potent** | -1 to Perception and ranged attacks for 1 round; also can’t become Undetected for 1 round. |
| **Standard** | -1 to Perception and ranged attacks for 1 round. |
| **Diluted** | -1 to Perception and ranged attacks for 1 round. (weaker; shorten duration / reduce magnitude). |
