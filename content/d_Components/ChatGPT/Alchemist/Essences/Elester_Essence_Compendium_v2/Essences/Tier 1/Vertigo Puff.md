...
tags:
  ...
  - tier-1
  - toxin
description: 'Dizzying cloud: movement feels wrong.'
price: TODO
chance-of-detection: 0%
file.name: Vertigo Puff
file.path: >-
...
---
# —
#aspirant #essence #ground-catalyst #inhaled #md #tier-1 #toxin
...
## Description
*Dizzying cloud: movement feels wrong.*
...
| Potency | Effects |
|---|---|
| **Potent** | All movement is difficult terrain for 2 rounds. |
| **Standard** | All movement is difficult terrain for 1 round. |
| **Diluted** | All movement is difficult terrain for 1 round. (weaker; shorten duration / reduce magnitude). |
