...
## Description
*A sturdy meal that blunts travel hardship.*
...
| Potency | Effects |
|---|---|
| **Potent** | Reduce cold/hunger penalty 1 step; +1 Survival until next Rest. |
| **Standard** | Reduce cold/hunger penalty 1 step until next Rest. |
| **Diluted** | Reduce cold/hunger penalty 1 step until next Rest. (weaker; shorten duration / reduce magnitude). |
