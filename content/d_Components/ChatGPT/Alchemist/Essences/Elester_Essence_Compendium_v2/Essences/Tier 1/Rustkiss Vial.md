...
tags:
  ...
  - tier-1
  - volatile
description: A small corrosive burst that eats flesh and gear.
price: TODO
chance-of-detection: 0%
file.name: Rustkiss Vial
file.path: >-
...
## Description
*A small corrosive burst that eats flesh and gear.*
...
| **Potent** | 2d6 damage. |
| **Standard** | 1d6 damage. |
| **Diluted** | 1 splash damage to primary target only. |
