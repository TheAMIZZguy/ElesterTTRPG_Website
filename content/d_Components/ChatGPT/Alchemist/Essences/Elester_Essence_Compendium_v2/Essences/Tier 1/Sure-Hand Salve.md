...
tags:
  ...
  - pd
  - tier-1
description: Steadies the next strike.
price: TODO
chance-of-detection: 0%
file.name: Sure-Hand Salve
file.path: >-
  d_Components/ChatGPT/Alchemist/Essences/Elester_Essence_Compendium_v2/Essences/Tier
  1/Sure-Hand Salve.md
file.folder: >-
  d_Components/ChatGPT/Alchemist/Essences/Elester_Essence_Compendium_v2/Essences/Tier
  1
---
# —
#binder #contact #essence #fortifier #ground-catalyst #pd #tier-1
...
| Potency | Effects |
|---|---|
| **Potent** | +2 to your next attack roll. |
| **Standard** | +1 to your next attack roll. |
| **Diluted** | +1 to your next attack roll. (weaker; shorten duration / reduce magnitude). |
