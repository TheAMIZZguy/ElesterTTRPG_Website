...
## Description
*A brief etch that weakens physical defense.*
...
| Potency | Effects |
|---|---|
| **Potent** | -1 PD for 1 minute (or until cleansed). |
| **Standard** | -1 PD until end of next turn. |
| **Diluted** | -1 PD until end of next turn. (weaker; shorten duration / reduce magnitude). |
