...
tags:
  ...
  - tier-2
  - volatile
description: Stronger blight caustic burst with residue.
price: TODO
chance-of-detection: 0%
file.name: Blight-Bite Vial
file.path: >-
  d_Components/ChatGPT/Alchemist/Essences/Elester_Essence_Compendium_v2/Essences/Tier
  2/Blight-Bite Vial.md
file.folder: >-
  d_Components/ChatGPT/Alchemist/Essences/Elester_Essence_Compendium_v2/Essences/Tier
  2
---
# —
#caustic #essence #ground-catalyst #named-reagent #pd #shatter #tier-2 #volatile

| Brewing | Delivery | Market |
|---|---|---|
| **Tier**: 2 <br> **Brew DC**: `= 10 + 2 * this.tier` | **Delivery**: Shatter (Vial) <br> **Defense**: PD | **Price**: TODO |
...
## Description
*Stronger blight caustic burst with residue.*
...
| Potency | Effects |
|---|---|
| **Potent** | 3d6 damage and lingering residue (1 round; GM). |
| **Standard** | 2d6 damage. |
| **Diluted** | 1d6 damage. |
