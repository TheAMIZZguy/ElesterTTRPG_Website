...
tags:
  ...
  - solvent
  - tier-2
description: +1 PD for 10 minutes
price: TODO
chance-of-detection: TODO%
file.name: Crampseed Draft
file.path: >-
  d_Components/ChatGPT/Alchemist/Essences/Elester_Essence_Compendium_v2/Essences/Tier
  2/Crampseed Draft.md
file.folder: >-
  d_Components/ChatGPT/Alchemist/Essences/Elester_Essence_Compendium_v2/Essences/Tier
  2
---
# —
#essence #fortifier #ground-catalyst #ingested #pd #solvent #tier-2

| Brewing | Delivery | Market |
|---|---|---|
| **Tier**: 2 <br> **Brew DC**: `= 10 + 2 * this.tier` | **Delivery**: Ingested (Potion/Food) <br> **Defense**: PD | **Price**: TODO |
...
| Potency | Effects |
|---|---|
| **Potent** | +1 PD for 10 minutes (strong). |
| **Standard** | +1 PD for 10 minutes. |
| **Diluted** | +1 PD for 1 minute. |
