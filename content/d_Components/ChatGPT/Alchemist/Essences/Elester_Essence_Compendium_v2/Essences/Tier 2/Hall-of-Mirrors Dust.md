...
tags:
  ...
  - tier-2
  - toxin
description: Distortion dust that ruins sight-based precision.
price: TODO
chance-of-detection: 0%
file.name: Hall-of-Mirrors Dust
file.path: >-
  d_Components/ChatGPT/Alchemist/Essences/Elester_Essence_Compendium_v2/Essences/Tier
  2/Hall-of-Mirrors Dust.md
file.folder: >-
  d_Components/ChatGPT/Alchemist/Essences/Elester_Essence_Compendium_v2/Essences/Tier
  2
---
# —
#aspirant #essence #ground-catalyst #inhaled #md #named-reagent #tier-2 #toxin
...
## Description
*Distortion dust that ruins sight-based precision.*
...
| Potency | Effects |
|---|---|
| **Potent** | -2 to sight-based attacks for 2 rounds. |
| **Standard** | -2 to sight-based attacks for 1 round. |
| **Diluted** | -1 to sight-based attacks for 1 round. |
