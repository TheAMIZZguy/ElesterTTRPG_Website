...
---
# —
#essence #ground-catalyst #ingested #md #solvent #tier-2 #toxin
...
| Potency | Effects |
|---|---|
| **Potent** | 3d6 damage. Also Target takes -1 to mental actions for 10 minutes. |
| **Standard** | 2d6 damage. Target takes -1 to mental actions for 10 minutes. |
| **Diluted** | 1d6 damage. Target takes -1 to mental actions for 1 minute. |
