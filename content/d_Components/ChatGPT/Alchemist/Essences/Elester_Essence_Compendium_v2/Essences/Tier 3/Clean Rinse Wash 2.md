...
file.name: Clean Rinse Wash 2
file.path: >-
  d_Components/ChatGPT/Alchemist/Essences/Elester_Essence_Compendium_v2/Essences/Tier
  3/Clean Rinse Wash 2.md
file.folder: >-
  d_Components/ChatGPT/Alchemist/Essences/Elester_Essence_Compendium_v2/Essences/Tier
  3
---
# —
#contact #essence #ground-catalyst #pd #solvent #tier-3 #toxin
...
| Potency | Effects |
|---|---|
| **Potent** | 4d6 damage. Also Target's next AP spent on Strikes costs +1 AP (GM). |
| **Standard** | 3d6 damage. Target's next AP spent on Strikes costs +1 AP (GM). |
| **Diluted** | 2d6 damage. Target's next AP spent on Strikes costs +1 AP (GM). |
