...
file.name: Neutral Balm Wash
file.path: >-
  d_Components/ChatGPT/Alchemist/Essences/Elester_Essence_Compendium_v2/Essences/Tier
  3/Neutral Balm Wash.md
file.folder: >-
  d_Components/ChatGPT/Alchemist/Essences/Elester_Essence_Compendium_v2/Essences/Tier
  3
---
# —
#caustic #contact #essence #ground-catalyst #named-reagent #pd #solvent #tier-3
...
| Potency | Effects |
|---|---|
| **Potent** | 4d6 damage. Also Target takes -1 PD until end of next turn. |
| **Standard** | 3d6 damage. Target takes -1 PD until end of next turn. |
| **Diluted** | 2d6 damage. Target takes -1 PD until end of next turn. |
