...
file.name: Antidote Sip Coat
file.path: >-
  d_Components/ChatGPT/Alchemist/Essences/Elester_Essence_Compendium_v2/Essences/Tier
  3/Antidote Sip Coat.md
file.folder: >-
  d_Components/ChatGPT/Alchemist/Essences/Elester_Essence_Compendium_v2/Essences/Tier
  3
---
# —
#binder #caustic #essence #ground-catalyst #injury #pd #tier-3

| Brewing | Delivery | Market |
|---|---|---|
| **Tier**: 3 <br> **Brew DC**: `= 10 + 2 * this.tier` | **Delivery**: Injury (Coat/Dart) <br> **Defense**: PD | **Price**: TODO |
...
| Potency | Effects |
|---|---|
| **Potent** | 4d6 damage. Also Target takes -10 ft speed for 1 round. |
| **Standard** | 3d6 damage. Target takes -10 ft speed for 1 round. |
| **Diluted** | 2d6 damage. Target takes -9 ft speed for 1 round. |
